...
hist(result1$SPD, main = "Histogram of Total Steps per Day", xlab = "Total Steps/Day", border = "blue", col = "brown", breaks = 20)
...
activity$steps[steps_na] -> result1
...
activity %>% na.omit() %>% group_by(interval) %>% summarise(Mean_S = mean(steps)) -> mean_spi
